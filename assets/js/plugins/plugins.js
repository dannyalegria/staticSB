...
!function(a) {
    function b() {
        ...
        q && g.one("transitionend", function() {
            q.focus()
        })
    }
    function c() {
    ...
    function f() {
        ...
        a(t).on("click", function() {
            var b = a(this);
            b.hasClass(v) ? (a(t).addClass(v).removeClass(u),
            b.removeClass(v).addClass(u)) : b.addClass(v).removeClass(u)
        })
    }
    var g = a(".pushy")
      , h = a("body")
    ...
    a(document).keyup(function(a) {
        27 == a.keyCode && (h.hasClass(l) || h.hasClass(m)) && (w ? c() : (e(),
        x = !1),
        p && p.focus())
    });
    var w = function() {
        ...
        if (null !== document.body) {
            ...
            for (var d in c)
                void 0 !== a.style[d] && (a.style[d] = "translate3d(1px,1px,1px)",
